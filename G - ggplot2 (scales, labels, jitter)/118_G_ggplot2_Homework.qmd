...
To the best of your ability, recreate the following plot from the `murders` dataset. Focus your efforts on getting the content correct. If you have time at the end, as a bonus, you can try to match the styling as closely as you can.![](https://github.com/emalcolmwhite/STAT0118/blob/main/MATH0118_G_ggplot3_gapminder_labels.jpg?raw=true)
